...
export const Section = ({ className, id, crosses, crossesOffset, customPaddings, children }) => {
    return (
        ...
        >
            ...
            <div className="hidden absolute top-0 left-5 h-full bg-stroke-1 pointer-events-none w-0.25 md:block lg:left-7.5 xl:left-10" />
            <div className="hidden absolute top-0 right-5 h-full bg-stroke-1 pointer-events-none w-0.25 md:block lg:right-7.5 xl:right-10" />
