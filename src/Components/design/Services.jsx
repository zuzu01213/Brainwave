...
export const PhotChatMessage = () => {
  return (
    <div className="absolute top-44 right-8 max-w-[17.5rem] py-6 px-8 bg-black rounded-t-xl rounded-bl-xl font-code text-base lg:top-40 lg:right-[8.75rem] lg:max-w-[17.5rem]">
